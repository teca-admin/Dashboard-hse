            ...
            <tr className="bg-slate-50 border-b border-slate-100">
              {headers.map((header) => (
                <th 
                  ...
                  className="px-6 py-5 text-[10px] font-bold text-slate-500 uppercase tracking-[0.15em] cursor-pointer hover:bg-slate-100 transition-colors group"
                >
                  <div className="flex items-center gap-2">
                    <span className="group-hover:text-indigo-600 transition-colors">{header.label}</span>
                    <span className="shrink-0 text-slate-300 group-hover:text-indigo-500">
          ...
          <tbody className="divide-y divide-slate-50">
            {loading ? (
              ...
              sortedData.map((row, idx) => (
                <tr 
                  key={idx} 
                  className="hover:bg-slate-50/50 transition-colors group border-transparent border-l-4 hover:border-indigo-500"
                >
